...
client = OpenAI(api_key='sk-proj-fHix21n73g8kFLNkGqK8T3BlbkFJ5SKyuJueKvJXXXXXXXXX') # Replace with your key
# Configure Cloudinary with your credentials
cloudinary.config(
  cloud_name = 'dufmnXXXX',  # Replace with your cloud name
  api_key = '411XXXXXXXXXXXX',        # Replace with your API key
  api_secret = '4xaqMk9n6RC7XXXXXXXXXXXX_XX'   # Replace with your API secret
)
